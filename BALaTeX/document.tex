...
\title{Design und Implementierung einer Serverless Infrastructure Anwendung beim Cloud Anbieter Amazon Web Services}
...
\input{90-Anhang/Teil1}
\section{Anhang Teil 2}
\input{90-Anhang/Teil2}
