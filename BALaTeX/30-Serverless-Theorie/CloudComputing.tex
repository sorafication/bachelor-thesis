...
\end{figure}
   ...
   Der Dienst AWS Lambda wird für die Implementierung der Anwendung verwendet und im Abschnitt \ref{Lambda} \nameref{Lambda} im Detail erläutert und im Abschnitt 4.X auch
