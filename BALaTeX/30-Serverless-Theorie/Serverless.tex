...
Wie bereits im Abschnitt \textit{\ref{Motivation} \nameref{Motivation}} erwähnt wurde beschäftigt sich die Abteilung Datacenter and Clouds seit längerem mit Cloud Computing und hat auch schon Projekte mit unterschiedlichen Servicemodellen realisiert.
