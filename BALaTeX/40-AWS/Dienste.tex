...
Zusätzlich kann AppSync eine Autorisierung mit dem Dienst AWS Cognito (siehe \ref{Cognito} \nameref{Cognito}) ermöglichen.
...
Beide Dienste für die API sind zudem direkt in Amplify (siehe \ref{Amplify} \nameref{Amplify}) integriert und benötigen keine separate Konfiguration.
...
Ein Prototyp kann ebenfalls schnell erstellt werden.
 ...
 Dies führt zu einer besseren Übersicht und einfacheren Einstieg in die Realisierung.
