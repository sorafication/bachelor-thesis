...
Mithilfe desrersten \verb+GET+ Anfrage kann eine Liste von Accounts abgerufen werden, die zweite \verb+GET+ Anfrage liefert nur die Informationen für den Eintrag \glqq 123\grqq{}  der Accountnamen.
...
Der Zugriff auf AWS Organizations sowie die Accountstruktur der Mediengruppe RTL werden im Abschnitt (\ref{Accountstruktur} \nameref{Accountstruktur}) genauer erläutert.
...
Dafür wird eine eigene \glqq amplifyapp.com\grqq-Subdomain bereitgestellt.
